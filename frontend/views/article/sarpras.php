            ...
            <div class="row j-masonry b-col-default-indent">
                    ...
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Kantin Sekolah</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Kantin sekolah yang berada di dalam sekolah dengan makanan yang selalu segar. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="j-masonry-item col-xs-12 col-md-4">
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Laboratorium Fisika</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Lab. Fisika lengkap beserta alat-alat fisika yang memadai berguna untuk mendukung siswa praktikum. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="j-masonry-item col-xs-12 col-md-4">
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Majalah Dinding</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Majalah Dinding yang selalu update berita dan pengumuman untuk siswa yang di kelolah oleh para siswa sendiri. </p>
                            </div>
                        </div>
                    </div>
                </div>
                 <div class="j-masonry-item col-xs-12 col-md-4">
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Ruang UKS</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Ruang UKS dengan perlatan P3k lengkap berguna buat penangan pertolongan pertama untuk siswa yang lagi sakit. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="j-masonry-item col-xs-12 col-md-4">
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Lapangan Basket</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Fasilitas Lapangan Basket yang luas dan bersih. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="j-masonry-item col-xs-12 col-md-4">
                    <div class="b-blog-preview">
                        ...
                        <div class="b-blog-preview__content b-diagonal-line-bg-light">
                            <div class="b-blog-preview__content-padding_box">
                                <p class="f-blog-preview__content-title f-primary-b"><a href="#">Kamar Kecil / Toilet</a></p>
                                <p class="f-blog-preview__content-date f-primary-it"><?= date('d F Y')?></p>
                                <p class="b-blog-preview__content-text f-blog-preview__content-text">Toilet yang bersih dan nyaman. </p>
                            </div>
                        </div>
                    </div>
                </div>
